...
function scheme_constructor(i,table) {
  var scheme = {
    'story_id' : Number(i),
    'stanza_id' : app.schema.stories[Number(i)].stanzas.length,
    'stanza' : {
      'theme' : table[0],
      'tactics' : table[1],
      'locality' : table[2]
...
// parent element is .stanza - separate background, natural flex positioning
